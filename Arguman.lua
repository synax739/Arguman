-- // Delta Mobil – MM2: Panel + Zıplama Butonu + GUN ESP (GunDrop + Mesafe)
...
local gunESPObjects = {}      -- Gun ESP için
...
local function createPanel()
    ...
    -- Katil (Speed + Jump)
    local killerPage = Instance.new("Frame", content)
