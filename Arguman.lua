-- // Delta Mobil – MM2: ESP + GUN ESP + Panel (Debug bilgilerine göre düzenlendi)
...
local cfg = {
    ...
    esp_dist = true,
    esp_maxDist = 500,
    gun_esp = true,          -- Yerdeki Gun'ları göster
    aim_on = false,
    aim_maxDist = 120,
    aim_smoothBase = 2.0,
    speed_on = false,
...
local gunESPObjects = {}   -- Yerdeki silahlar için
...
-- ==============================================
-- ROL TESPİTİ (Debug bilgilerine göre)
-- ==============================================
local function getPlayerRole(plr)
    ...
    -- Silah kontrolü (Debug'da Gun ismi geçiyor)
...
-- ==============================================
-- YERDEKİ SİLAH ESP (GUN ESP) - Debug'daki "Gun" ismine göre
-- ==============================================
local function updateGunESP()
    ...
    pcall(function()
        local guns = {}
        -- Tüm workspace'i tara, Tool ve adı "Gun" olanları bul
...
local function createPanel()
    ...
    panel.Size = UDim2.new(0,280,0,230) panel.Position = UDim2.new(1,-290,0,60)
